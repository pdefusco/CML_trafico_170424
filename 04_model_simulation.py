...
dg = DataGen(USERNAME, STORAGE, DBNAME, CONNECTION_NAME)
...
model_name = f"TimeSeriesQuery-{USERNAME}" # Update model name here
...
def submitQuery(Model_AccessKey):
    ...
    randomInts = [random.randint(10,50) for i in range(4)]
    record = '{"pattern": ""}'
